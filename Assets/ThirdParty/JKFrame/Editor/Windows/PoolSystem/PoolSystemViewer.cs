...
namespace JKFrame.Editor
{
    public class PoolSystemViewer : EditorWindow
    {
        ...
        public void CreateGUI()
        {
            ...
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/ThirdParty/JKFrame/Editor/Windows/PoolSystem/PoolSystemViewer.uxml");
        ...
        {
            VisualTreeAsset template = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/ThirdParty/JKFrame/Editor/Windows/PoolSystem/PoolSystemItem.uxml");
