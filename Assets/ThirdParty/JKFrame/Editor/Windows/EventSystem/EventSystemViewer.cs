...
public class EventSystemViewer : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/ThirdParty/JKFrame/Editor/Windows/EventSystem/EventSystemViewer.uxml");
        VisualElement elementUXML = visualTree.Instantiate();

        // 导入USS样式，绑定到实例化对象上,添加到UI根元素容器下
        var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/ThirdParty/JKFrame/Editor/Windows/EventSystem/EventSystemViewer.uss");
